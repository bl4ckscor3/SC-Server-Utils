...
public class Configuration {
	...
	Configuration(ModConfigSpec.Builder builder) {
		...
		muteMessages = pushPop(builder, "Mute Messages", "Messages relating to the mute system", () ->
						new MuteMessages(
								builder.comment("Message sent when cancelling a muted player's message").define("cancelledMessageMute", "{translate:\"scserverutils.mute.message_cancelled\",fallback:\"You can't send messages while muted.\",with:[],type:\"translatable\",color:\"red\"}"),  //works
								builder.comment("Message sent when cancelling a suspended player's message").define("cancelledMessageSuspend", "{translate:\"scserverutils.mute.message_cancelled_suspended\",fallback:\"You can't send messages while suspended.\",with:[],type:\"translatable\",color:\"red\"}"),  //works
								...
								builder.comment("Message sent when a mute ends").define("muteEnds", "{translate:\"scserverutils.mute.mute_ends\",fallback:\"You were unmuted my an operator. You can now send messages in chat. Don't break the rules anymore!\",with:[],type:\"translatable\",color:\"green\"}"),  //works
